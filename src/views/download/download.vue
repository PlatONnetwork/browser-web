<template>
    <div class="download-wrap">
        ...
        <div class="exportname">{{exportname=='node'?$t('nodeInfo.node'):$t('contract.address')}}&nbsp;#&nbsp;{{address}}</div>
        <p class="download-msg">{{exportname=='node'?$t('download.downloadNodeMsg'):$t('download.downloadAddressMsg')}}</p>
        <div class='download'>
