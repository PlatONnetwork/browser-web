                    ...
                    <el-table :data="tableData" style="width: 100%"   key='firstTable'  size="mini" :row-class-name="tableRowClassName">
                        ...
                        <el-table-column  label="发送方">
                            <template slot-scope="scope">
                                ...
                                <span @click='filterFn(scope.row.from)'><i class="el-icon-info"></i></span>
                            </template>
                        </el-table-column>
                        <el-table-column label="接收方">
                            <template slot-scope="scope">
                                ...
                                <span v-if='scope.row.txType !== "contractCreate"' @click='filterFn(scope.row.to)'><i class="el-icon-info"></i></span>
                            </template>
                        </el-table-column>
