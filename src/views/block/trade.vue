            ...
            <div class="bottom">
                ...
                <div class="table">
                    <el-table :data="tableData" style="width: 100%" key='firstTable' size="mini" :row-class-name="tableRowClassName">
                        <el-table-column :label="$t('tradeAbout.hash')" show-overflow-tooltip width='200'>
                        ...
                        <el-table-column :label="$t('tradeAbout.from')" show-overflow-tooltip width='200'>
                            <template slot-scope="scope">
                        ...
                        <el-table-column :label="$t('tradeAbout.to')" show-overflow-tooltip width='200'>
                            <template slot-scope="scope">
