                    ...
                    <el-table :data="tableData" style="width: 100%" key='firstTable' size="mini" :row-class-name="tableRowClassName" @row-click='rowClick'>
                        ...
                        <el-table-column  :label="$t('nodeInfo.electionStatus')">
                            <template slot-scope="scope">
                                ...
                                <span :class='{"node-candidate":scope.row.nodeType == "candidates","node-validator":scope.row.nodeType == "validator","node-nominees":scope.row.nodeType == "nominees"}'>{{ $t('nodeInfo.' + scope.row.nodeType)}}</span>
                            </template>
                        </el-table-column>
