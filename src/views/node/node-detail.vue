            ...
            <div v-show="tabIndex==1">
                ...
                <List>           
                    <Item :label="$t('nodeInfo.nodeID')">
                        ...
                        <b class="cursor copyicon" :class="{copy:!isCopy}" v-clipboard:copy="detailInfo.nodeId" v-clipboard:success="onCopy" v-clipboard:error="onError">{{copyText}}</b>
                    </Item>
                    <Item :label="$t('tradeAbout.operatorAddress')">
                        ...
                        <b class="cursor copyicon" :class="{copy:!isCopy2}" v-clipboard:copy="detailInfo.stakingAddr" v-clipboard:success="onCopy" v-clipboard:error="onError">{{copyText2}}</b>
                    </Item>
                    <Item :label="$t('tradeAbout.rewardAddress')">
                        ...
                        <b class="cursor copyicon" :class="{copy:!isCopy3}" v-clipboard:copy="detailInfo.denefitAddr" v-clipboard:success="onCopy" v-clipboard:error="onError">{{copyText3}}</b>
                    </Item>
