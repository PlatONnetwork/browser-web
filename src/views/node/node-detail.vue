<template>
    <div class="contract-detail-wrap">
        ...
        <div class="node-header">
            <div class="node-header-left">
                ...
                <div class="node-name-wrap">
                    ...
                    <p>{{$t('contract.createdat')}}: {{detailInfo.joinTime}}</p>
                </div>
            </div>
            <div class="node-header-right">
                <span class="green vote-status">active</span>
            </div>
        </div>
        <div class="node-statistic">
            <List class="node-statistic-left" :inline="true">           
                <Item :label="$t('nodeInfo.electedRoundValidator')" :prop="detailInfo.nodeName" width="165"></Item>
                <Item :label="$t('nodeInfo.totalReward')" :prop="detailInfo.rewardValue+' LAT'"></Item>
                <Item :label="$t('nodeInfo.blocks')" :prop="detailInfo.blockQty" width="165"></Item>
                <Item :label="$t('nodeInfo.yield')" :prop="detailInfo.expectedIncome"></Item>
                <Item :label="$t('nodeInfo.blockRate')" :prop="detailInfo.expectBlockQty" width="165"></Item>
            ...
            <div class="node-statistic-right">
                <canvas style="width:88px;height:88px;"></canvas>
                <div class="statistic-right-data">
                    <Item :label="$t('nodeInfo.totalStakePower')" :prop="detailInfo.totalValue"></Item>
                    <ul>
                        <li>
                            <label>{{$t('nodeInfo.selfstake')}}：</label>
                            <p>{{detailInfo.stakingValue}}LAT</p>
                        </li>
                        <li>
                            <label>{{$t('deleget.delegations')}}：</label>
                            <p>{{detailInfo.delegateValue}}LAT</p>
                        </li>
                        <li>
                            <label>{{$t('deleget.delegators')}}：</label>
                            <p>{{detailInfo.delegateQty}}LAT</p>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="tabs">
            ...
            <el-button size="medium" :class="{active:tabIndex==4}" @click="tabChange(4)">{{$t('deleget.delegations')}}</el-button>
        </div>
        <div class="node-detail-content">
            <div v-show="tabIndex==1">
                ...
                <List>           
                    ...
                    <Item :label="$t('tradeAbout.operatorAddress')">
                        <span class="blue cursor">{{detailInfo.stakingAddr}}</span>
                    ...
                    <Item :label="$t('tradeAbout.rewardAddress')">
                        <span class="blue cursor">{{detailInfo.denefitAddr}}</span>
                    ...
                    <Item :label="$t('tradeAbout.website')">
                        <span class="blue cursor">{{detailInfo.website}}</span>
                    </Item>
                    <Item :label="$t('tradeAbout.identity')">
                        <span class="blue cursor">{{detailInfo.externalId}}</span>
                    </Item>
            ...
            <div v-show="tabIndex==2">
                <div class="address-trade-last node-last">            
                    ...
                    <el-button size="medium export-btn">{{$t('nodeInfo.export')}}</el-button>
                </div>
                <div class="table">
            ...
            <div v-show="tabIndex==3">
                <div class="table">
                    <el-table :data="tableOperateData" style="width: 100%" key='firstTable' size="mini">                       
                        ...
                        <el-table-column :label="$t('nodeInfo.inBlock')" show-overflow-tooltip>
                            <template slot-scope="scope">
                                <span>{{scope.row.value}} LAT</span>
                            </template>
                        </el-table-column>
            ...
            <div v-show="tabIndex==4">
                ...
                <div class="table">
                    <el-table :data="tableDelegetData" style="width: 100%" key='firstTable' size="mini">                       
                        ...
                        <el-table-column :label="$t('contract.delegations')+'\\'+$t('deleget.percentage')" show-overflow-tooltip>
                            <template slot-scope="scope">
                                <span>{{scope.row.value}} LAT</span>
                            </template>
                        </el-table-column>
